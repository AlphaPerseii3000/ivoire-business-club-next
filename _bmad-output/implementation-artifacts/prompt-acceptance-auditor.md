...
- **Spécifications (Spec File)** : [7-1-landing-page-avec-deals-teaser-et-seo.md](file:///d:/Code/ivoire-business-club-next/_bmad-output/implementation-artifacts/7-1-landing-page-avec-deals-teaser-et-seo.md) dans le workspace.
- **Contexte (Context Doc)** : [docs/AI-Powered-3D-website.md](file:///d:/Code/ivoire-business-club-next/docs/AI-Powered-3D-website.md) dans le workspace.
