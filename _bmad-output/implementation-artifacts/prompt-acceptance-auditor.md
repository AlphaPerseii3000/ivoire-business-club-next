...
- **Spécifications (Spec File)** : [spec-9-6-images-et-miniatures-articles.md](file:///d:/Code/ivoire-business-club-next/_bmad-output/implementation-artifacts/spec-9-6-images-et-miniatures-articles.md) dans le workspace.
