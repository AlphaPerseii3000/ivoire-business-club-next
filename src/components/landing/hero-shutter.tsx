...
export function HeroShutter() {
  ...
  // Scale of video (decreases in Phase 1: 0 to 800px, which is about 0 to 0.33 of the scroll space)
  const videoScale = useTransform(scrollYProgress, [0, 0.33], [1.3, 1.0]);

  // Opacities for videos
  ...
  useEffect(() => {
    ...
    const handleScrollEvent = () => {
      ...
      // Phase 1 (0 to 800px): scrub video A from 0.0s to 2.4s
      ...
      // Phase 2 (800px to 2600px): Play loop video
    ...
    >
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="absolute inset-0 z-0">
          {useFallback ? (
            ...
            <motion.div style={{ scale: videoScale }} className="relative w-full h-full bg-black">
              ...
              {/* Video A: Growing Tree (Phase 1, 0-800px) */}
              <motion.video
                ref={videoGrowingRef}
              ...
              {/* Video B: Loop (Phase 2, 800px-2600px) */}
              <motion.video
                ref={videoLoopRef}
        ...
        <div className="relative z-30 mx-auto max-w-7xl px-6 w-full h-full grid grid-cols-1 md:grid-cols-12 gap-8 items-center pt-16 md:pt-0">
          ...
          {/* Left Rail: Title, Description, CTAs */}
          <motion.div
            style={{ y: leftRailY }}
