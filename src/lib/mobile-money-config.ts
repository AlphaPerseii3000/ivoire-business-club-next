...
export const MOBILE_MONEY_CONFIG = {
  WAVE: {
    label: "Wave",
    colorClass: "blue",
    merchantNumber: process.env.NEXT_PUBLIC_WAVE_MERCHANT_NUMBER || "+225 01 23 45 67 89",
    dialPrefix: process.env.NEXT_PUBLIC_WAVE_DIAL_PREFIX || "*144#",
    instructionLines: [
      "Ouvre ton application Wave.",
      "Transfère le montant au numéro marchand affiché.",
      "Indique impérativement la référence dans la description.",
    ],
  },
  ORANGE_MONEY: {
    label: "Orange Money",
    colorClass: "orange",
    merchantNumber: process.env.NEXT_PUBLIC_ORANGE_MONEY_MERCHANT_NUMBER || "+225 07 99 88 77 66",
    ussdCode: process.env.NEXT_PUBLIC_ORANGE_MONEY_USSD_CODE || "#144#",
    instructionLines: [
      "Compose le code USSD ou ouvre ton application Orange Money.",
      "Effectue un dépôt/transfert vers le numéro marchand affiché.",
      "Indique impérativement la référence dans la description.",
    ],
  },
} as const;
